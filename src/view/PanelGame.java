...
public class PanelGame extends JPanel {
    ...
    PanelGame() {
        ...
        btnGameNewStart.setBounds(472, 515, 120, 35);
        lblScore.setBounds(25, 520, 220, 25);
        lblInfo.setBounds(255, 520, 215, 25);
    ...
    public void setScoreText(String text) {lblScore.setText(text);}
    public void setInfoText(String text) {lblInfo.setText(text);}
    ...
    public void resetButtonIcon(int index, ImageIcon icon) {
        buttonsGame.get(index).setIcon(icon);
        buttonsGame.get(index).setBackground(UIManager.getColor("Button.background"));
    }
    ...
    public void createGameField(int row_size, int col_size) {
        ...
        panelGameField.setLayout(new GridLayout(row_size, col_size, 3, 3));
